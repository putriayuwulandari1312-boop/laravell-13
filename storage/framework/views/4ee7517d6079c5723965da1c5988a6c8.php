                ...
                <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
                    ...
                    <div class="md:col-span-8">
                        <div class="border border-gray-200 rounded-2xl p-6">
                            <h3 class="text-xl font-bold text-gray-900"><?php echo e($product->title); ?></h3>
                            ...
                            <p class="text-gray-700">
                                Stock : <span class="font-semibold"><?php echo e($product->stock); ?></span>
                            </p>
                        </div>
                    </div>
                </div>
...
<?php /**PATH C:\laragon\www\laravel-13\laravel-13\resources\views/products/show.blade.php ENDPATH**/ ?>